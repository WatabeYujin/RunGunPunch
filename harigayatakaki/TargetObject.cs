...
public class TargetObject : MonoBehaviour {
    ...
    [SerializeField]
    public EnchantmentStatus enchantmentStatus; //ターゲットが与える効果(enum)
    [SerializeField]
    ...
    private void Start()
    {
        robotControl =GameObject.FindGameObjectWithTag(Tag.Player).GetComponent<RobotControl>();
    }
    ...
    void TargetBreak()
    {
        ...
        switch (enchantmentStatus)
        {
            case EnchantmentStatus.Reverse:
                robotControl.abnormalStatus.Reverse = !robotControl.abnormalStatus.Reverse;
